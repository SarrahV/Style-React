    ...
    return (
        <div  className="home-content">
          <div className="home-section">
             ...
             <p>Don't worry! Contrary to what you have heard, there are actually many ways to style in React (not to be confused with React Native...that's another ball of wax).The most important thing to remember is to pick the best tools for the job. A simple app like this could do with plain old css or a bit of Sass if you are feeling fancy. Bigger, more complicated apps require more planning and architecture to ensure style stays consistent across many components.</p>
